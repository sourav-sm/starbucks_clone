  ...
  <div>
    ...
    <div style={{fontFamily:"sans-serif",display:"flex",flexDirection:"row",justifyContent:"space-between",background:"white",padding:"20px",textAlign:"center"}}>
      ...
      <div style={{display:"flex",flexDirection:"row",gap:"20px",fontSize:"15px",fontWeight:"bold"}}>
        <img style={{height:"50px",cursor:"pointer"}} src={logo} alt="Logo" />
        <div style={{paddingTop:"15px",cursor:"pointer"}}>MENU</div>
        <div style={{paddingTop:"15px",cursor:"pointer"}}>REWARD</div>
        <div style={{paddingTop:"15px",cursor:"pointer"}}>GIFT CARDS</div>
      </div>
      <div style={{display:"flex",flexDirection:"row",fontSize:"15px",fontWeight:"bold"}}>
         <div style={{display:"flex",flexDirection:"row",padding:"20px",gap:"10px",cursor:"pointer"}}>
           <FaLocationDot />
